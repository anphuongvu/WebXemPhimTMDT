...
namespace Nhom3_WebXemPhim.Areas.Admin.Controllers
{
    public class VouchersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaVoucher,TenVoucher,DieuKien,NgayApDung,NgayHetHan,TrangThai")] Voucher voucher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaVoucher,TenVoucher,DieuKien,NgayApDung,NgayHetHan,TrangThai")] Voucher voucher)
        {
            if (ModelState.IsValid)
            {
